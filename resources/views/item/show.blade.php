				...
				<div class="card-body">
        			...
        			<input type="hidden" name="id" value="{{ request()->get('id') }}">
			  		...
			  		<div class="form-group {{ $errors->has('code') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="code" class="form-control" value="{{ $item->code }}"  required readonly>
                            @if ($errors->has('code'))
			  		...
			  		<div class="form-group {{ $errors->has('type_id') ? ' has-error' : '' }}">
                        ...
                        <select name="type_id" id="inputType" class="form-control" required readonly>  
                    ...
                    <div class="form-group {{ $errors->has('size_id') ? ' has-error' : '' }}">
                        <label for="inputSize">Size</label>
                            <select name="size_id" id="inputSize" class="form-control" required readonly>
                    ...
                    <div class="form-group {{ $errors->has('unit_id') ? ' has-error' : '' }}">
                        <label for="inputUnit">Unit</label>
                            <select name="unit_id" id="inputUnit" class="form-control" required readonly>
                      ...
                      <div class="form-group {{ $errors->has('weight_id') ? ' has-error' : '' }}">
                        ...
                        <select name="weight_id" id="inputWeight" class="form-control" required readonly>
                    ...
                    <div class="form-group {{ $errors->has('price') ? ' has-error' : '' }}">
			  			...
			  			<input type="number" name="price" class="form-control" value="{{ $item->price }}"  required readonly>
                            @if ($errors->has('price'))
                                <span class="help-block">
